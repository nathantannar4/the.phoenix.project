...
public final class APNSPayload: Content {
...
extension APNSPayload {
    ...
    public static var contentAvailable: APNSPayload {
...
/// Equatable
extension APNSPayload: Equatable {
    public static func ==(lhs: APNSPayload, rhs: APNSPayload) -> Bool {
